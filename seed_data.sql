...
(1, 'admin', 'admin@bookverse.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 1, 'LOCAL', NOW(), NOW()),
(2, 'tinvo', 'tinvo@example.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 1, 'LOCAL', NOW(), NOW()),
(3, 'nguyenvan', 'nguyen@example.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 1, 'LOCAL', NOW(), NOW()),
(4, 'lethithu', 'lethu@example.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 1, 'LOCAL', NOW(), NOW()),
(5, 'phamhoang', 'phamhoang@example.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 1, 'LOCAL', NOW(), NOW());
...
(1, 1, 'Admin User', 'https://i.pravatar.cc/150?u=admin', 'System Administrator', '+84901234567', '1990-01-01', 'OTHER', 'BUSINESS', 0, NULL, NULL, 5.0, 0, NULL, NOW(), NOW()),
(2, 2, 'Tin Vo', 'https://i.pravatar.cc/150?u=tinvo', 'Passionate book collector and seller', '+84912345678', '1995-05-15', 'MALE', 'BUSINESS', 1, '2 hours', 98.5, 4.8, 45, '2024-01-01', NOW(), NOW()),
(3, 3, 'Nguyen Van A', 'https://i.pravatar.cc/150?u=nguyen', 'Love reading and sharing books', '+84923456789', '1992-08-20', 'MALE', 'PERSONAL', 0, '5 hours', 95.0, 4.5, 12, '2024-06-15', NOW(), NOW()),
(4, 4, 'Le Thi Thu', 'https://i.pravatar.cc/150?u=lethu', 'Book enthusiast', '+84934567890', '1998-03-10', 'FEMALE', 'PERSONAL', 0, NULL, NULL, 4.7, 8, NULL, NOW(), NOW()),
(5, 5, 'Pham Hoang', 'https://i.pravatar.cc/150?u=pham', 'Second-hand book specialist', '+84945678901', '1993-11-25', 'MALE', 'BUSINESS', 1, '1 hour', 99.0, 4.9, 120, '2023-03-01', NOW(), NOW());
...
(1, 2, 'Tin Vo', '+84912345678', '123 Nguyen Hue', 'Ben Nghe', 'District 1', 'Ho Chi Minh City', 'Vietnam', '700000', 1, NOW(), NOW()),
(2, 3, 'Nguyen Van A', '+84923456789', '456 Le Loi', 'Ben Thanh', 'District 1', 'Ho Chi Minh City', 'Vietnam', '700000', 1, NOW(), NOW()),
(3, 4, 'Le Thi Thu', '+84934567890', '789 Tran Hung Dao', 'Cau Ong Lanh', 'District 1', 'Ho Chi Minh City', 'Vietnam', '700000', 1, NOW(), NOW()),
(4, 5, 'Pham Hoang', '+84945678901', '321 Hai Ba Trung', 'Da Kao', 'District 1', 'Ho Chi Minh City', 'Vietnam', '700000', 1, NOW(), NOW());
...
(1, 1, 2, NULL, 35.00, 45.00, 'USD', 'LIKE_NEW', 3, 'Excellent condition, barely used. Perfect for Java developers!', 'Ho Chi Minh City, Vietnam', 'ACTIVE', 1, 10.00, 30.00, 40.00, 125, 15, 2, 1, '2-3 days', 'Ho Chi Minh City', NOW(), NOW()),
(2, 1, 3, 'Effective Java - Great Condition', 30.00, 45.00, 'USD', 'GOOD', 2, 'Good condition with minor wear. All pages intact.', 'Hanoi, Vietnam', 'ACTIVE', 1, 10.00, 25.00, 40.00, 80, 8, 1, 0, '3-5 days', 'Hanoi', NOW(), NOW()),
(3, 2, 2, NULL, 28.00, 40.00, 'USD', 'LIKE_NEW', 5, 'Almost new condition. A must-have for software engineers!', 'Ho Chi Minh City, Vietnam', 'ACTIVE', 1, 10.00, 25.00, 35.00, 200, 32, 5, 1, '2-3 days', 'Ho Chi Minh City', NOW(), NOW()),
(4, 2, 5, 'Clean Code - Professional Edition', 32.00, 40.00, 'USD', 'NEW', 10, 'Brand new, sealed copy. Perfect gift for developers!', 'Da Nang, Vietnam', 'ACTIVE', 1, 10.00, 28.00, 38.00, 150, 20, 3, 1, '1-2 days', 'Da Nang', NOW(), NOW()),
(5, 3, 3, NULL, 18.00, 25.00, 'USD', 'GOOD', 4, 'Good reading condition. Fascinating historical perspective.', 'Hanoi, Vietnam', 'ACTIVE', 1, 10.00, 15.00, 22.00, 90, 12, 2, 0, '3-5 days', 'Hanoi', NOW(), NOW()),
(6, 4, 5, NULL, 15.00, 20.00, 'USD', 'ACCEPTABLE', 2, 'Well-loved copy, some wear on cover. Great story!', 'Da Nang, Vietnam', 'ACTIVE', 1, 10.00, 10.00, 18.00, 300, 45, 8, 1, '2-3 days', 'Da Nang', NOW(), NOW()),
(7, 5, 2, NULL, 12.00, 15.00, 'USD', 'GOOD', 3, 'Classic dystopian novel in good condition.', 'Ho Chi Minh City, Vietnam', 'ACTIVE', 1, 10.00, 10.00, 14.00, 180, 28, 4, 1, '2-3 days', 'Ho Chi Minh City', NOW(), NOW()),
(8, 6, 3, 'The Alchemist - Inspirational', 14.00, 18.00, 'USD', 'LIKE_NEW', 6, 'Beautiful edition, like new. Inspirational read!', 'Hanoi, Vietnam', 'ACTIVE', 1, 10.00, 12.00, 16.00, 110, 18, 3, 0, '3-5 days', 'Hanoi', NOW(), NOW()),
(9, 7, 5, NULL, 13.00, 16.00, 'USD', 'GOOD', 4, 'The Great American Novel in good condition.', 'Da Nang, Vietnam', 'ACTIVE', 1, 10.00, 11.00, 15.00, 95, 14, 2, 1, '2-3 days', 'Da Nang', NOW(), NOW()),
(10, 8, 2, NULL, 16.00, 20.00, 'USD', 'LIKE_NEW', 3, 'Powerful story, excellent condition.', 'Ho Chi Minh City, Vietnam', 'ACTIVE', 1, 10.00, 14.00, 18.00, 140, 22, 3, 1, '2-3 days', 'Ho Chi Minh City', NOW(), NOW());
...
(1, 1, 3, 5, 'Excellent Java Resource', 'This book is a must-read for any serious Java developer. Clear explanations and best practices.', 1, 25, NOW(), NOW()),
(2, 1, 4, 4, 'Very Helpful', 'Great book, learned a lot about Java patterns and practices.', 0, 12, NOW(), NOW()),
(3, 2, 3, 5, 'Clean Code Changed My Career', 'This book transformed how I write code. Highly recommended!', 1, 45, NOW(), NOW()),
(4, 2, 5, 5, 'Must-Have for Developers', 'Every developer should read this book. Game changer!', 1, 38, NOW(), NOW()),
(5, 3, 2, 5, 'Mind-Blowing', 'Changed my perspective on human history. Absolutely brilliant!', 1, 120, NOW(), NOW()),
(6, 4, 3, 5, 'Magical', 'The book that started it all. Timeless classic!', 1, 200, NOW(), NOW()),
(7, 5, 4, 5, 'Prophetic and Disturbing', 'Still relevant today. Orwell was a visionary.', 0, 85, NOW(), NOW()),
(8, 6, 2, 4, 'Inspiring Journey', 'Beautiful story about following your dreams.', 1, 65, NOW(), NOW());
...
(1, 'ORD-2026-0001', 3, 'DELIVERED', 70.00, 5.00, 7.50, 0.00, 82.50, 'CREDIT_CARD', 'PAID', 2, 2, DATE_SUB(NOW(), INTERVAL 30 DAY), DATE_SUB(NOW(), INTERVAL 25 DAY)),
(2, 'ORD-2026-0002', 4, 'SHIPPED', 43.00, 5.00, 4.80, 0.00, 52.80, 'PAYPAL', 'PAID', 3, 3, DATE_SUB(NOW(), INTERVAL 5 DAY), DATE_SUB(NOW(), INTERVAL 3 DAY)),
(3, 'ORD-2026-0003', 5, 'PROCESSING', 32.00, 0.00, 3.20, 0.00, 35.20, 'CREDIT_CARD', 'PAID', 4, 4, DATE_SUB(NOW(), INTERVAL 1 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY));
...
(1, 1, 1, 2, 'Effective Java', 'Joshua Bloch', 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=800', 1, 35.00, 35.00, 'DELIVERED', DATE_SUB(NOW(), INTERVAL 30 DAY)),
(2, 1, 3, 2, 'Clean Code', 'Robert C. Martin', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=800', 1, 28.00, 28.00, 'DELIVERED', DATE_SUB(NOW(), INTERVAL 30 DAY)),
(3, 2, 6, 5, 'Harry Potter and the Philosopher''s Stone', 'J.K. Rowling', 'https://images.unsplash.com/photo-1551847812-f815db5b52e3?w=800', 1, 15.00, 15.00, 'SHIPPED', DATE_SUB(NOW(), INTERVAL 5 DAY)),
(4, 2, 10, 2, 'To Kill a Mockingbird', 'Harper Lee', 'https://images.unsplash.com/photo-1485988412941-77a35537dae4?w=800', 1, 16.00, 16.00, 'SHIPPED', DATE_SUB(NOW(), INTERVAL 5 DAY)),
(5, 3, 4, 5, 'Clean Code - Professional Edition', 'Robert C. Martin', 'https://images.unsplash.com/photo-1519682337058-a94d519337bc?w=800', 1, 32.00, 32.00, 'PROCESSING', DATE_SUB(NOW(), INTERVAL 1 DAY));
...
(1, 1, 'PENDING', 'Order placed', DATE_SUB(NOW(), INTERVAL 30 DAY)),
(2, 1, 'CONFIRMED', 'Order confirmed by seller', DATE_SUB(NOW(), INTERVAL 29 DAY)),
(3, 1, 'PROCESSING', 'Order is being prepared', DATE_SUB(NOW(), INTERVAL 28 DAY)),
(4, 1, 'SHIPPED', 'Order has been shipped', DATE_SUB(NOW(), INTERVAL 27 DAY)),
(5, 1, 'DELIVERED', 'Order delivered successfully', DATE_SUB(NOW(), INTERVAL 25 DAY)),
-- Order 2 timeline (In transit)
(6, 2, 'PENDING', 'Order placed', DATE_SUB(NOW(), INTERVAL 5 DAY)),
(7, 2, 'CONFIRMED', 'Order confirmed by seller', DATE_SUB(NOW(), INTERVAL 4 DAY)),
(8, 2, 'SHIPPED', 'Order has been shipped', DATE_SUB(NOW(), INTERVAL 3 DAY)),
-- Order 3 timeline (Processing)
(9, 3, 'PENDING', 'Order placed', DATE_SUB(NOW(), INTERVAL 1 DAY)),
...
(1, 'WELCOME10', 'Welcome discount for new users', 'PERCENT', 10.00, 20.00, 10.00, 100, 15, 1, NOW(), DATE_ADD(NOW(), INTERVAL 30 DAY), NOW(), NOW()),
(2, 'NEWYEAR2026', 'New Year 2026 special discount', 'PERCENT', 15.00, 50.00, 20.00, 200, 45, 1, DATE_SUB(NOW(), INTERVAL 5 DAY), DATE_ADD(NOW(), INTERVAL 25 DAY), NOW(), NOW()),
(3, 'FREESHIP', 'Free shipping voucher', 'FIXED', 5.00, 30.00, 5.00, 50, 8, 1, NOW(), DATE_ADD(NOW(), INTERVAL 15 DAY), NOW(), NOW());
...
(1, 3, 'ORDER', 'Order Delivered', 'Your order #ORD-2026-0001 has been delivered successfully.', 1, 1, DATE_SUB(NOW(), INTERVAL 25 DAY)),
(2, 3, 'PROMOTION', 'New Year Sale!', 'Get 15% off on all books with code NEWYEAR2026', 1, NULL, DATE_SUB(NOW(), INTERVAL 5 DAY)),
(3, 4, 'ORDER', 'Order Shipped', 'Your order #ORD-2026-0002 has been shipped.', 0, 2, DATE_SUB(NOW(), INTERVAL 3 DAY)),
(4, 5, 'ORDER', 'Order Confirmed', 'Your order #ORD-2026-0003 has been confirmed.', 0, 3, DATE_SUB(NOW(), INTERVAL 1 DAY)),
(5, 2, 'LISTING', 'New Review', 'Someone left a 5-star review on your listing.', 0, 1, NOW());
...
-- ALTER TABLE `author` AUTO_INCREMENT = 9;
-- ALTER TABLE `book_meta` AUTO_INCREMENT = 9;
-- ALTER TABLE `listing` AUTO_INCREMENT = 11;
